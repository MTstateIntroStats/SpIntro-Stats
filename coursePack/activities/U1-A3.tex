...
\end{key}
     ...
     \item \label{3000SRSs} Click the ``More Samples:'' choices to
...
\end{key}
     ...
     \item  If the sampling method is unbiased, the estimates of the
       ...
       centered around the population average word length of 4.29.
...
\end{key}
     \item  Click on the rightmost blue dot. What is your langest
