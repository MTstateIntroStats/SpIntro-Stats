...
They studied that night and went in the next day at the time the professor had told them. He placed them in separate rooms and handed each of them a test booklet, 
and told them to begin. 

They looked at the first problem, worth 5 points. It was something simple about exploratory data analysis. "Cool," they thought at the same time, each one in his 
...
\newpage
\item Did you use some method of selection?  How did you choose your ten
  words?
\begin{students}
  \vspace{1cm}
\end{students}    
...
\url{http://www.rossmanchance.com/applets/OneSample.html?population=gettysburg}
   ...
   \item  Click \fbox{Clear} and erase all the data in the box.
     \item Copy the word length data from D2L.  Select the entire file
       ...
       data box (use control-V or the mouse option).   Click \fbox{Use
       Data}. You
     ...
     \item Click ``Show Sampling Options''.  Change Number of Samples to
       \fbox{1 } and Sample Size to \fbox{10}.  Click \fbox{Draw
           Samples}.   Write 
...
\end{key}
     ...
     \item  Click  \fbox{Generate 1 sample} again and record the next
       mean.
\begin{students}
  \vspace{1cm}
\end{students}    
...
\end{key}
     ...
     \item \label{3000SRSs} Click  \fbox{Generate 1000 samples} three
