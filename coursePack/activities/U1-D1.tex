...
\item {\bf Turn OFF your cell phone}.
\end{itemize}
...
The Departmental administrators in the math office are very busy
people. They cannot accept assignments and cannot provide information
about grades (check on D2L).
...
\item  Complete {\bf Quiz 1} on working in groups.
\item Read the Syllabus and pages 9--12 for the next class. You will
  be quizzed over them. 
\end{itemize}
