...
\begin{enumerate}
  \item Write down a sequence of 45 coin flips (so 45 {\sf H}'s or
    {\sf T}'s)
...
\end{key}
  ...
  \item Now flip your coin 45 times and write down the result of each
    flip ({\sf H}'s or {\sf T}'s). \vspace{.5in} 
\begin{students}
  \vspace{1cm}
\end{students}    
\begin{key}
...
\textbf{Further Exploration}
  ...
  \item What could instructors do to be more convincing that they 
