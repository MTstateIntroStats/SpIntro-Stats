  ...
  ## Bootstrap Demo  ---------------------------------------
{
  ...
  ## sample: 1, 10, 100, 1000, 5000, [Start Over]
      ...
      column(6,  div( 
       ...
       column(6,
              div(
                ...
                ##textInput("q1_sampSize", label = "Sample Size: ","10" ),
                uiOutput('q1_SampDemoSample' ),
                  br(),
                  div(
                    actionButton("q1_SampDemo_1", "Draw one Sample"),
                    h5("(Clear and restart)")
                  ),
                  if(length(q1Samp$samples)>1){
                    div(
                    fluidRow(
                      column(4,  h4("How many more samples?")),
