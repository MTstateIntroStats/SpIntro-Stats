...
babies (ages 4 to 10 months) some peanut protein. 

The researchers want to answer this question:
\begin{center}
  {\large\sf  Does feeding babies peanuts prevent peanut allergies?} 
\end{center}
{\bf
Discuss the Following Questions	}

\begin{enumerate}
  \item  What is the treatment condition in this study? 
\begin{students}
\vspace{2cm}
\end{students}

\begin{key}
  {\it Feeding an infant 6 g per week of peanut protein or avoiding
    peanut protein. }
\end{key}
...
avoidance group, 35 (13.7\%) of 255 infants developed allergic symptoms to peanuts.
...
\item Of the 245 subjects assigned to the eat peanuts, what proportion
  improved? We will label this 
     ...
     in the notes for day 4,  we ornament $p$ with a ``hat'' on top to
...
\end{key}
   ...
   \item What proportion of all 500 subjects improved?  This is called
     ...
     true marginal probability that any infant will develop peanut
...
\end{key}
       ...
       Go back to ``Enter Data'' and change labels slightly to clear
