...
\end{key}
  ...
  \item  An experiment tried to compare the effects
    of energy drinks with and without alcohol on human subjects: \\
    Pharmacology is the study of how drugs affect the body. An article
    in {\it Human Psycopharmacology} in 2009 reported on an experiment
    intended to tease out some of the effects and to compare an energy
    drink without alcohol  to one with alcohol and to a non-energy
    drink.  The research question is: 
...
\end{key}
 ...
 \item  Go to the applet and select \fbox{Test} uder {One of Each}.
   \begin{enumerate}
   \item 
...
\vspace{6cm}
 ...
 \item  Lurking variables were discussed on Activity 9.  When we
...
\item Write up the results of the hypothesis test as a report using
  the five elements from Activity 10.  Be sure to refer to the response
