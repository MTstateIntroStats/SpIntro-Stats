...
In the  dolphin therapy study we found strong evidence of a
...
\item  What are the cases in the plot? % What changes when you
%  click on a bar? 
\begin{students}
 \vspace{1cm}
\end{students}
...
\item  We're not told exactly what the researchers were thinking ahead
  ...
  \fbox{Less than} or both as ``more extreme'' results to find the p-value? 
