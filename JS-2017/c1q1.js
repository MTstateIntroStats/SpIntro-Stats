...
function summarizeDiff() {
	...
	histogram( [x, c1q1Groups], c1q1SumSVG, c1q1InteractFnA );	
      ...
      c1q1Summ.innerHTML = "x&#773;<sub>1</sub> = " + xbar1.toPrecision(4) + 
      						" x&#773;<sub>2</sub> =  " + xbar2.toPrecision(4) + 
	...
	var check, 
 	...
 	sc1q1Len = sampleTstc1q1.length;
 	 ...
 	 c1q1Tstdata = [sampleTstc1q1, c1q1Color];
   	 c1q1InfOutput = discreteChart(c1q1Tstdata, C1Q1InfSVG, c1q1TestInteract ); 	
