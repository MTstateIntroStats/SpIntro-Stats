...
\item \label{cards} Your group will get 30 cards on which you will write the
  ...
  \item Reshuffling is slow, so we want to speed up the
    ...
    Then choose \fbox{Estimate} from the \fbox{One Categ} menu.
...
\end{key}
 ...
 \item You should have 101 resampled values in your plot. If you have
   more than that, go  back to \fbox{Enter/Describe Data} and make any
   small change in the spelling. Then come back to \fbox{Estimate} and
